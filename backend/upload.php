...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $stmt = $pdo->prepare("INSERT INTO studies (patient_id, doctor_id, study_name, file_url, file_type, study_date) VALUES (?, ?, ?, ?, ?, ?)");
        $stmt->execute([$patientId, $doctorId, $studyName, $fileUrl, $type, $studyDate]);
